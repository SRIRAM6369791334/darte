!(function () {
            ...
            .forEach(function (e) {
                if (e) {
                    switch (t) {
                        case "en":
                        default:
                            e.src = "assets/images/flags/us.webp";
                            break;
                        case "sp":
                            e.src = "assets/images/flags/spain.webp";
                            break;
                        case "gr":
                            e.src = "assets/images/flags/germany.webp";
                            break;
                        case "it":
                            e.src = "assets/images/flags/italy.webp";
                            break;
                        case "ru":
                            e.src = "assets/images/flags/russia.webp";
                    }
    ...
    function l() {
        setTimeout(function () {
            ...
            if (t) {
                var e = t.querySelector(".mm-active .active"),
                    a = e ? e.offsetTop : 0;
                if (a > 300) {
                    a -= 100;
                    var n = document.getElementsByClassName("vertical-menu")
    ...
    function r(t, e) {
        ...
        var n = setInterval(function () {
            a.style.opacity || (a.style.opacity = 1),
                a.style.opacity > 0
                    ? (a.style.opacity -= 0.2)
                    : (clearInterval(n), (a.style.display = "none"));
        }, 200);
    }
    function d() {
                    ...
                    null !== e &&
                        ...
                        1 ==
                            document.getElementById("layout-direction-ltr")
                                .checked && "layout-direction-ltr" === a
                            ? (document
    ...
    (window.onload = function () {
        ...
        (function () {
            ...
            for (
                var e,
                    a = document.getElementsByClassName("vertical-menu-btn"),
                    n = 0;
                n < a.length;
                n++
            )
        ...
        (function () {
            ...
            var t = document.getElementsByTagName("body")[0],
                e = document.querySelectorAll(".light-dark");
            e &&
                e.forEach(function (e) {
                    e.addEventListener("click", function (e) {
                        t.hasAttribute("data-layout-mode") &&
                        "dark" == t.getAttribute("data-layout-mode")
                            ? (c("layout-mode-light"),
                              document.body.setAttribute(
                                  "data-layout-mode",
                                  "light"
                ...
                (t = document.getElementsByTagName("body")[0]).hasAttribute(
                    "data-layout"
                ) && "horizontal" == t.getAttribute("data-layout")
                    ? (c("layout-horizontal"),
                      document.getElementById("sidebar-setting") && (document.getElementById("sidebar-setting").style.display = "none"),
                      document.getElementsByClassName("vertical-menu")[0] && (document.getElementsByClassName("vertical-menu")[0].style.display = "none"),
                      document.getElementsByClassName("ishorizontal-topbar")[0] && (document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "block"),
                      document.getElementsByClassName("isvertical-topbar")[0] && (document.getElementsByClassName("isvertical-topbar")[0].style.display = "none"))
                    : (c("layout-vertical"),
                      document.getElementById("sidebar-setting") && (document.getElementById("sidebar-setting").style.display = "block"),
                      document.getElementsByClassName("vertical-menu")[0] && (document.getElementsByClassName("vertical-menu")[0].style.display = "block"),
                      window.innerWidth <= 992 &&
                          document.getElementsByClassName("vertical-menu")[0] &&
                ...
                "dark" == t.getAttribute("data-layout-mode")
                    ? c("layout-mode-dark")
                    : c("layout-mode-light"),
                t.hasAttribute("data-layout-size") &&
                "boxed" == t.getAttribute("data-layout-size")
                    ? c("layout-width-boxed")
                    : c("layout-width-fluid"),
                t.hasAttribute("data-layout-scrollable") &&
                "true" == t.getAttribute("data-layout-scrollable")
                    ? c("layout-position-scrollable")
                    : c("layout-position-fixed"),
                t.hasAttribute("data-topbar") &&
                "dark" == t.getAttribute("data-topbar")
                    ? c("topbar-color-dark")
                    : c("topbar-color-light"),
                t.hasAttribute("data-sidebar-size") &&
                "sm" == t.getAttribute("data-sidebar-size")
                    ? c("sidebar-size-small")
                    : t.hasAttribute("data-sidebar-size") &&
                      "md" == t.getAttribute("data-sidebar-size")
                    ? c("sidebar-size-compact")
                    : c("sidebar-size-default"),
                t.hasAttribute("data-sidebar") &&
                "brand" == t.getAttribute("data-sidebar")
                    ? c("sidebar-color-brand")
                    : t.hasAttribute("data-sidebar") &&
                      "dark" == t.getAttribute("data-sidebar")
