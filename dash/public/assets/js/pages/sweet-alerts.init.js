document.getElementById("sa-basic").addEventListener("click", function () {
    ...
    document.getElementById("sa-image").addEventListener("click", function () {
        Swal.fire({
            ...
            imageUrl: "assets/images/logo-sm.webp",
            imageHeight: 40,
            confirmButtonColor: "#3980c0",
            animation: !1,
        });
    ...
    document
        ...
        .addEventListener("click", function () {
            Swal.fire({
                ...
                icon: "info",
                html: 'You can use <b>bold text</b>, <a href="//MilkVandi.in/">links</a> and other HTML tags',
                showCloseButton: !0,
                showCancelButton: !0,
    ...
    document
        ...
        .addEventListener("click", function () {
            Swal.fire({
                ...
                padding: 100,
                confirmButtonColor: "#3980c0",
                background: "#fff url(assets/images/auth-bg.webp)",
            });
        }),
    document
