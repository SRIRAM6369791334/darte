                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-3">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p>We have sent you verification email <span class="fw-bold">example@abc.com</span>,
                                            Please check it</p>
                                        <div class="mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center text-muted p-4">
                            <p class="text-white-50">©
                                ...
                                </script> Yesbe. Crafted with <i class="mdi mdi-heart text-danger"></i>
                                by Sai techno Solutions
                            </p>
                        </div>
                    </div>
                </div>
