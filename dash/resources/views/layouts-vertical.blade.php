                ...
                <div class="card-body">
                    <div class="text-center py-3">
                        ...
                        <div class="main-wid position-relative">
                            <h3 class="text-white">Yesbe Dashboard</h3>
                            ...
                            <div class="">
                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <span class="badge badge-soft-primary">25.4%<i
                                ...
                                <div class="mt-3 border-top pt-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <span class="badge badge-soft-primary">17.4%<i
                                                    class="mdi mdi-arrow-down ms-2"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 border-top pt-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <span class="badge badge-soft-success">16.3%<i
                                ...
                                <div class="mt-3 border-top pt-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <span class="badge badge-soft-primary">65.7%<i
                                                    class="mdi mdi-arrow-up ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 20px;"><img
                                                    src="{{ URL::asset('assets/images/users/avatar-4.webp') }}"
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-5.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-6.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-7.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-8.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-2.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                                <h6 class="font-size-15 mb-1">Marie Kim</h6>
                                                <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-map-marker"></i>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('assets/images/users/avatar-1.webp') }}"
                                                    class="avatar-sm rounded-circle " alt="..."></td>
                                            <td>
                                                <h6 class="font-size-15 mb-1">Sonya Henshaw</h6>
                                                <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-map-marker"></i>
                ...
                <div class="card-body pt-1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{ URL::asset('assets/images/flags/us.webp') }}" alt="user-image"
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('assets/images/flags/germany.webp') }}" alt="user-image"
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('assets/images/flags/italy.webp') }}" alt="user-image"
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('assets/images/flags/spain.webp') }}" alt="user-image"
