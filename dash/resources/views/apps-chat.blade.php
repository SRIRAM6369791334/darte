                    ...
                    <div class="p-3 px-4">
                        <div class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3 align-self-center">
                                <img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" class="avatar-sm rounded-circle" alt="">
                            </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-shrink-0 me-3 align-self-center">
                                                        <div class="user-img online">
                                                            <img src="{{ URL::asset('assets/images/users/avatar-2.webp') }}" class="rounded-circle avatar-sm" alt="">
                                                ...
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <div class="user-img away">
                                                            <img src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" class="rounded-circle avatar-sm" alt="">
                                                            <span class="user-status"></span>
                                                        </div>
                                                    </div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-shrink-0 align-self-center me-3">
                                                        <div class="user-img">
                                                            <img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" class="rounded-circle avatar-sm" alt="">
                                                            <span class="user-status"></span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="conversation-list">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <h5 class="font-size-14 conversation-name"><a href="#" class="text-dark">John Howard</a> <span class="d-inline-block font-size-12 text-muted time">10:06 AM</span></h5>
                                                    <p class="mb-0">
                                                        img-1.webp & img-2.webp images for a New Projects
                                                    </p>

                                                    <ul class="list-inline message-img mt-3  mb-0">
                                                        <li class="list-inline-item message-img-list">
                                                            <a class="d-inline-block m-1" href="">
                                                                <img src="{{ URL::asset('assets/images/small/img-1.webp') }}" alt="" class="rounded img-thumbnail">
                                                            </a>
                                                        </li>

                                                        <li class="list-inline-item message-img-list">
                                                            <a class="d-inline-block m-1" href="">
                                                                <img src="{{ URL::asset('assets/images/small/img-2.webp') }}" alt="" class="rounded img-thumbnail">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
