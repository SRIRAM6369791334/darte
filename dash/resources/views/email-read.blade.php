                        ...
                        <div class="mt-2">
                            <a href="#" class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded-circle" src="assets/images/users/avatar-2.webp" alt="Generic placeholder image" height="36">
                                </div>
                            ...
                            <a href="#" class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded-circle" src="assets/images/users/avatar-3.webp" alt="Generic placeholder image" height="36">
                                </div>
                            ...
                            <a href="#" class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded-circle" src="assets/images/users/avatar-4.webp" alt="Generic placeholder image" height="36">
                                </div>
                            ...
                            <a href="#" class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded-circle" src="assets/images/users/avatar-6.webp" alt="Generic placeholder image" height="36">
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start mb-4">
                                    <div class="flex-shrink-0 me-3">
                                        <img class="rounded-circle avatar" src="assets/images/users/avatar-2.webp" alt="Generic placeholder image">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-2 col-6">
                                        <div class="card border shadow-none">
                                            <img class="card-img-top img-fluid" src="assets/images/small/img-3.webp" alt="Card image cap">
                                    ...
                                    <div class="col-xl-2 col-6">
                                        <div class="card border shadow-none">
                                            <img class="card-img-top img-fluid" src="assets/images/small/img-4.webp" alt="Card image cap">
                                            <div class="py-2 text-center">
                                                <a href="" class="fw-medium">Download</a>
                                            </div>
                                        </div>
