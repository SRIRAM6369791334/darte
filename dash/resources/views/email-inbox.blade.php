                    ...
                    <div class="mt-2">
                        <a href="#" class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{ URL::asset('assets/images/users/avatar-2.webp') }}" alt="Generic placeholder image" height="36">
                            </div>
                        ...
                        <a href="#" class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" alt="Generic placeholder image" height="36">
                            </div>
                        ...
                        <a href="#" class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" alt="Generic placeholder image" height="36">
                            </div>
                        ...
                        <a href="#" class="d-flex align-items-start">
                            <div class="flex-shrink-0 me-3">
                                <img class="rounded-circle" src="{{ URL::asset('assets/images/users/avatar-6.webp') }}" alt="Generic placeholder image" height="36">
                            </div>
