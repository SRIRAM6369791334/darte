    ...
    <div class="navbar-header">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                            id="topnav-ecommerce" role="button">@lang('translation.Ecommerce') <div
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                            id="topnav-invoice" role="button"><span
                                                data-key="t-invoices">@lang('translation.Invoices')</span>
                                            <div class="arrow-down"></div>
                                        </a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                            ...
                                            <a href="contacts-profile" class="dropdown-item"
                                                data-key="t-user-settings">@lang('translation.User_Profile')</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                            ...
                                            <a href="auth-logout" class="dropdown-item"
                                                data-key="t-logout">@lang('translation.Log_Out') </a>
                                    ...
                                    <a href="layouts-vertical" class="dropdown-item"
                                        data-key="t-vertical">@lang('translation.Vertical')</a>
                                </div>
                            </li>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <img class="header-lang-img" src="{{ URL::asset('assets/images/flags/us.webp') }}"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                        <img src="{{ URL::asset('assets/images/flags/us.webp') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="{{ URL::asset('assets/images/flags/spain.webp') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="{{ URL::asset('assets/images/flags/germany.webp') }}" alt="user-image"
                            class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                        <img src="{{ URL::asset('assets/images/flags/italy.webp') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="{{ URL::asset('assets/images/flags/russia.webp') }}" alt="user-image"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    @switch(Session::get('lang'))
                        @case('ru')
                            <img src="{{ URL::asset('/assets/images/flags/russia.webp') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @case('it')
                            <img src="{{ URL::asset('/assets/images/flags/italy.webp') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @case('de')
                            <img src="{{ URL::asset('/assets/images/flags/germany.webp') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @case('es')
                            <img src="{{ URL::asset('/assets/images/flags/spain.webp') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @default
                            <img src="{{ URL::asset('/assets/images/flags/us.webp') }}" alt="Header Language" height="16">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="{{ url('index/es') }}" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="{{ URL::asset('/assets/images/flags/spain.webp') }}" alt="user-image"
                    ...
                    <a href="{{ url('index/it') }}" class="dropdown-item notify-item language" data-lang="it">
                        <img src="{{ URL::asset('/assets/images/flags/italy.webp') }}" alt="user-image"
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 250px;">
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start bg-light">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('assets/images/users/avatar-3.webp') }}"
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}"
                                        class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ asset('/assets/images/users/avatar-1.webp') }}" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <form id="logout_formasd" action="{{ route('logout') }}" method="POST" style="display: none;">
                        @csrf
                    </form>
                </div>
            </div>
