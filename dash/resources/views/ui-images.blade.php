            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="rounded me-2" alt="200x200" width="200" src="{{ URL::asset('assets/images/small/img-4.webp') }}" data-holder-rendered="true">
                                </div><!-- end col -->
                                <div class="col-md-6">
                                    <div class="mt-4 mt-md-0">
                                        <img class="rounded-circle avatar-xl" alt="200x200" src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" data-holder-rendered="true">
                                    </div>
                                </div><!-- end col -->
                            </div><!-- end row -->
                        </div><!-- end card-body -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <img class="img-thumbnail" alt="200x200" width="200" src="{{ URL::asset('assets/images/small/img-3.webp') }}" data-holder-rendered="true">
                                </div><!-- end col -->
                                <div class="col-md-6">
                                    <div class="mt-4 mt-md-0">
                                        <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200" src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" data-holder-rendered="true">
                                    </div>
                                </div><!-- end col -->
                            </div><!-- end row -->
                        </div><!-- end card-body -->
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <img src="{{ URL::asset('assets/images/small/img-2.webp') }}" class="img-fluid" alt="Responsive image">
                            </div>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" alt="" class="rounded avatar-sm">
                                                <p class="mt-2 mb-lg-0"><code>.avatar-sm</code></p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" alt="" class="rounded avatar-md">
                                                <p class="mt-2  mb-lg-0"><code>.avatar-md</code></p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.webp') }}" alt="" class="rounded avatar-lg">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" alt="" class="rounded-circle avatar-sm">
                                                <p class="mt-2 mb-lg-0"><code>.avatar-sm</code></p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" alt="" class="rounded-circle avatar-md">
                                                <p class="mt-2  mb-lg-0"><code>.avatar-md</code></p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-4">
                                            <div>
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.webp') }}" alt="" class="rounded-circle avatar-lg">
                                                <p class="mt-2 mb-lg-0"><code>.avatar-lg</code></p>
                                            </div>
                                        </div><!-- end col -->
                                    </div><!-- end row -->
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded avatar-md" src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" alt="Generic placeholder image">
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded avatar-md" src="{{ URL::asset('assets/images/users/avatar-5.webp') }}" alt="Generic placeholder image">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-end">
                                <div class="flex-shrink-0 me-3">
                                    <img class="rounded avatar-md" src="{{ URL::asset('assets/images/users/avatar-1.webp') }}" alt="Generic placeholder image">
                                </div>
                                <div class="flex-grow-1">
