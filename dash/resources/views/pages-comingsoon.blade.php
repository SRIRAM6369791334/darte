...
@section('content')
    ...
    <div class="authentication-bg min-vh-100" style="background: url(./assets/images/auth-bg.webp) bottom;">
                ...
                <div class="col-8">
                    <div class="home-wrapper text-center">
                        <a href="index" class="auth-logo">
                            <span class="logo-lg">
                                <img src="assets/images/logo-sm.svg" alt="" height="22"> <span class="logo-txt">Yesbe</span>
                            </span>
                        </a>
                        <h3 class="mt-3">Let's get started with Yesbe</h3>
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-lg-6 col-sm-5">
                                <div class="maintenance-img mb-5">
                                    <img src="{{ URL::asset('assets/images/coming-soon-img.webp') }}" alt="" class="img-fluid mx-auto d-block">
                                </div>
                            </div>
                        </div>
