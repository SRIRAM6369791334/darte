                                    ...
                                    <li class="event-list">
                                        ...
                                        <p class="text-muted">At vero eos dignissimos ducimus quos
                                            ...
                                            <div class="d-flex flex-wrap align-items-start event-img mt-3 gap-2">
                                                <img src="{{ URL::asset('assets/images/small/img-2.webp') }}" alt="" class="img-fluid rounded" width="60">
                                                <img src="{{ URL::asset('assets/images/small/img-5.webp') }}" alt="" class="img-fluid rounded" width="60">
                                            </div>
                                    </li>
                                    <li class="event-list">
