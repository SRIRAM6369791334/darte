                                ...
                                <div data-simplebar style="max-height: 430px;">
                                    <div class="d-flex align-items-start border-bottom py-4">
                                        <div class="flex-shrink-0 me-2">
                                            <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-3.webp') }}" alt="avatar-3 images">
                                        </div>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-start mt-4">
                                                <div class="flex-shrink-0 me-2">
                                                    <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" alt="avatar-4 images">
                                                </div>
                                    ...
                                    <div class="d-flex align-items-start border-bottom py-4">
                                        <div class="flex-shrink-0 me-2">
                                            <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-5.webp') }}" alt="avatar-5 images">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start border-bottom py-4">
                                        <div class="flex-shrink-0 me-2">
                                            <img class="rounded-circle avatar-sm" src="{{ URL::asset('assets/images/users/avatar-7.webp') }}" alt="avatar-7 images">
                                        </div>
                    ...
                    <div class="card-body">
                        <div class="profile-content text-center">
                            <div class="profile-user-img">
                                <img src="{{ (isset(Auth::user()->avatar) && Auth::user()->avatar != '') ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.webp') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap">
                                <tbody>
                                    <tr>
                                        <td style="width: 50px;"><img src="{{ URL::asset('assets/images/users/avatar-2.webp') }}" class="rounded-circle avatar-sm" alt=""></td>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('assets/images/users/avatar-1.webp') }}" class="rounded-circle avatar-sm" alt=""></td>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('assets/images/users/avatar-4.webp') }}" class="rounded-circle avatar-sm" alt=""></td>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="text-start mt-2">
                                            <img src="{{ (isset(Auth::user()->avatar) && Auth::user()->avatar != '')  ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.webp') }}" alt="" class="rounded-circle avatar-lg">
                                        </div>
