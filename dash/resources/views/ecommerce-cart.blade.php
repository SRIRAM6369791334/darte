                ...
                <div class="col-xl-8">
                    <div class="card border shadow-none">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start border-bottom pb-3">
                                <div class="me-4">
                                    <img src="{{ URL::asset('./assets/images/product/img-1.webp') }}" alt="" class="avatar-lg">
                                </div>
                    ...
                    <div class="card border shadow-none">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start border-bottom pb-3">
                                <div class="me-4">
                                    <img src="{{ URL::asset('./assets/images/product/img-2.webp') }}" alt="" class="avatar-lg">
                                </div>
                                <div class="flex-grow-1 align-self-center overflow-hidden">
                                    <div>
                    ...
                    <div class="card border shadow-none">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start border-bottom pb-3">
                                <div class="me-4">
                                    <img src="{{ URL::asset('./assets/images/product/img-3.webp') }}" alt="" class="avatar-lg">
                                </div>
                                <div class="flex-grow-1 align-self-center overflow-hidden">
                                    <div>
