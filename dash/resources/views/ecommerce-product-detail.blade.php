                                        ...
                                        <div class="product-detail" dir="ltr">
                                            ...
                                            <div class="swiper product-thumbnail-slider rounded border overflow-hidden position-relative">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-1.webp') }}" class="img-fluid d-block" /></div>
                                                    <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-2.webp') }}" class="img-fluid d-block" /></div>
                                                    <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-3.webp') }}" class="img-fluid d-block" /></div>
                                                    <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-6.webp') }}" class="img-fluid d-block" /></div>
                                                    <div class="swiper-slide"><img src="{{ URL::asset('assets/images/product/img-5.webp') }}" class="img-fluid d-block" /></div>
                                                </div>
                                                ...
                                                <div thumbsSlider="" class="swiper product-nav-slider mt-2 overflow-hidden">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide rounded">
                                                            <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-1.webp') }}" class="img-fluid d-block" /></div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-2.webp') }}" class="img-fluid d-block" /></div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-3.webp') }}" class="img-fluid d-block" /></div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-6.webp') }}" class="img-fluid d-block" /></div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="nav-slide-item"><img src="{{ URL::asset('assets/images/product/img-5.webp') }}" class="img-fluid d-block" /></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <li class="list-inline-item">
                                                                    <a href="#" class="active" data-bs-toggle="tooltip" data-bs-placement="top" title="Gray">
                                                                        <div class="product-color-item">
                                                                            <img src="{{ URL::asset('assets/images/product/img-1.webp') }}" alt="" class="avatar-md">
                                                                        </div>
                                                                    </a>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Dark">
                                                                        <div class="product-color-item">
                                                                            <img src="{{ URL::asset('assets/images/product/img-2.webp') }}" alt="" class="avatar-md">
                                                                        </div>
                                                                    </a>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Purple">
                                                                        <div class="product-color-item">
                                                                            <img src="{{ URL::asset('assets/images/product/img-3.webp') }}" alt="" class="avatar-md">
                                                                        </div>
                                                                    </a>
                                                                </li>
                                                                <li class="list-inline-item">
                                                ...
                                                <div class="tab-content border border-top-0 p-4">
                                                    <div class="tab-pane fade" id="desc" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div>
                                                                    <img src="{{ URL::asset('assets/images/product/img-6.webp') }}" alt="" class="img-fluid mx-auto d-block">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-9">
                                                                <div class="text-muted">
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Sky">
                                                <div class="product-color-item">
                                                    <img src="{{ URL::asset('assets/images/product/img-4.webp') }}" alt="" class="avatar-md">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Green">
                                                <div class="product-color-item">
                                                    <img src="{{ URL::asset('assets/images/product/img-5.webp') }}" alt="" class="avatar-md">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="White">
                                                <div class="product-color-item">
                                                    <img src="{{ URL::asset('assets/images/product/img-6.webp') }}" alt="" class="avatar-md">
                                                </div>
                                            </a>
                                        </li>
