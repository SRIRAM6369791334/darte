                        ...
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="text-center mb-4">
                                <a href="index">
                                    ...
                                    <span class="logo-txt">Yesbe</span>
                                </a>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="text-center mt-2">
                                        ...
                                        <p class="text-muted">Re-Password with Milk Vandi.</p>
                                    </div>
                                    <div class="p-2 mt-4">
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="email"
                                                    ...
                                                    id="email" placeholder="Enter email" autocomplete="email" autofocus>
                                                @error('email')
                        ...
                        <div class="col-lg-12">
                            <div class="text-center text-muted p-4">
                                <p class="text-white-50">©
                                    ...
                                    </script> Milk Vandi. Crafted with <i
                                        class="mdi mdi-heart text-danger"></i> by MilkVandi
                                </p>
                            </div>
                        </div>
                    </div>
