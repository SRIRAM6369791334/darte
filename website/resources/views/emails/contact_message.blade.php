...
<head>
    ...
    <title>New Contact Message – DARTE Admin</title>
</head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; background-color:#ffffff; border:1px solid #eadfcb;">
                ...
                <tr>
                    <td bgcolor="#FBBB00" align="center" style="padding:22px 24px 18px 24px;">
                        <p style="margin:0 0 4px 0; font-size:22px; font-weight:900; color:#111111; font-family: Arial, Helvetica, sans-serif; letter-spacing:1px;">&#128172; New Contact Message</p>
                        <p style="margin:0; font-size:13px; color:#4a3a00; font-family: Arial, Helvetica, sans-serif;">A visitor has sent you a message through DARTE.</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:32px 36px 28px 36px;">
                        ...
                        <p style="margin:0 0 20px 0; font-size:15px; color:#555555; font-family: Arial, Helvetica, sans-serif; line-height:1.7;">
                            You have received a new contact message on DARTE. Details are listed below.
                        </p>

                        <!-- Sender Details -->
                        <p style="margin:0 0 16px 0; font-size:13px; font-weight:bold; color:#b87900; text-transform:uppercase; letter-spacing:1px; border-bottom:2px solid #b87900; padding-bottom:6px; font-family: Arial, Helvetica, sans-serif;">Sender Details</p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                            <tr>
                                ...
                                <td width="65%" style="padding:12px 14px; font-size:15px; font-weight:bold; color:#111111; font-family: Arial, Helvetica, sans-serif; border-bottom:1px solid #efe6d6;">{{ $contact->name ?? '' }}</td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding:12px 14px; font-size:14px; color:#333333; font-family: Arial, Helvetica, sans-serif; border-bottom:1px solid #efe6d6;">
                                    <a href="mailto:{{ $contact->email ?? '' }}" style="color:#b87900; text-decoration:none;">{{ $contact->email ?? '' }}</a>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#fbf8f0" style="padding:12px 14px; font-size:13px; font-weight:bold; color:#555555; font-family: Arial, Helvetica, sans-serif; border-bottom:1px solid #efe6d6; text-transform:uppercase; letter-spacing:0.5px;">Subject</td>
                                <td style="padding:12px 14px; font-size:14px; font-weight:bold; color:#333333; font-family: Arial, Helvetica, sans-serif; border-bottom:1px solid #efe6d6;">{{ $contact->subject ?? '' }}</td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
                            <tr>
                                <td bgcolor="#fbf8f0" style="border-left:3px solid #b87900; padding:18px 20px;">
                                    <p style="margin:0; font-size:15px; color:#333333; font-family: Arial, Helvetica, sans-serif; line-height:1.8; white-space:pre-line;">{{ $contact->message ?? '' }}</p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td bgcolor="#fff8e1" style="border-left:3px solid #b87900; padding:14px 18px; border-radius:0 4px 4px 0;">
                                    <p style="margin:0; font-size:13px; color:#555555; font-family: Arial, Helvetica, sans-serif; line-height:1.6;">
                                        &#128394;&nbsp; To reply, simply respond to <a href="mailto:{{ $contact->email ?? '' }}" style="color:#b87900; text-decoration:none;">{{ $contact->email ?? '' }}</a> directly.
                                    </p>
                                </td>
                            </tr>
                        </table>
