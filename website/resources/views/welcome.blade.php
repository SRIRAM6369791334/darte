...
@section('content')
                                ...
                                <ul class="filter-tag">
                                    @if(request('dzSearch'))
                                        <li style="background-color: red;">
                                            <a href="{{ route('shop', request()->except('dzSearch')) }}" class="tag-btn">
                                    ...
                                    @if(request('size'))
                                        <li>
                                            <a href="{{ route('shop', request()->except('size')) }}" class="tag-btn">
                                                Size: {{ request('size') }}
                                                <i class="icon feather icon-x tag-close"></i>
                                            </a>
                                        </li>
                                    ...
                                    @if(request('category'))
                                        ...
                                        @if($activeCategory)
                                            <li>
                                                <a href="{{ route('shop', request()->except('category')) }}" class="tag-btn">
                                                    Category:
                                                    {{ $activeCategory->category_name ?? $activeCategory->cate_name ?? $activeCategory->name }}
                                                    <i class="icon feather icon-x tag-close"></i>
                                                </a>
                                            </li>
                                        @endif
                                    ...
                                    @if(request()->filled('min_price') && request()->filled('max_price') && (request('min_price') > ($globalMinPrice ?? 0) || request('max_price') < ($globalMaxPrice ?? 1000)))
                                        <li>
                                                        ...
                                                        <div class="widget">
                                                            ...
                                                            <div class="btn-group product-size">
                                                                ...
                                                                @foreach ($sizes as $size)
                                                                    <input type="radio" class="btn-check" name="size" value="{{ $size }}"
                                                                        id="size{{ $size }}" {{ request('size') == $size ? 'checked' : '' }}>

                                                                    <label class="btn" for="size{{ $size }}">
                                                                        {{ $size }}
                                                                    </label>
                                                                @endforeach
                                    ...
                                    <aside>
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="price-slide range-slider">
                                                <div class="price">
                                                    <div class="range-slider style-1">
                                                        <!-- hidden inputs for filter formulation -->
                                                        ...
                                                        <div id="slider-tooltips2" class="mb-3"
                                                            data-min="{{ $globalMinPrice ?? 0 }}"
                                                            data-max="{{ $globalMaxPrice ?? 1000 }}"
                                                            data-start-min="{{ request('min_price', $globalMinPrice ?? 0) }}"
                                                            data-start-max="{{ request('max_price', $globalMaxPrice ?? 1000) }}">
                                                        </div>
                                                        <span class="example-val" id="slider-margin-value-min2"></span>
                                                        <span class="example-val" id="slider-margin-value-max2"></span>
                                                    </div>
                                                    <button type="submit" class="btn btn-secondary btn-sm mt-3 w-100">Apply
                                                        Filter</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="btn-group product-size">
                                                @foreach ($sizes as $index => $size)
                                                    <input type="radio" class="btn-check" name="size" value="{{ $size }}"
                                                        id="size{{ $index }}" {{ request('size') == $size ? 'checked' : '' }}
                                                        onchange="document.getElementById('filterForm').submit()">
                                                    <label class="btn" for="size{{ $index }}">{{ $size }}</label>
                                                @endforeach
                                            </div>
                                            {{-- Allow deselecting current size --}}
                                            @if(request('size'))
                                                <a href="{{ route('shop', request()->except('size')) }}"
                                        ...
                                        <div class="widget widget_categories">
                                            ...
                                            <ul>
                                                @foreach ($categories as $cat)
                                                    <li class="cat-item {{ request('category') == $cat->id ? 'active' : '' }}">
                                                        <a
                                                            href="{{ route('shop', array_merge(request()->query(), ['category' => $cat->id])) }}">
                                                            {{ $cat->category_name }}
                                                        </a> ({{ $cat->products_count ?? 0 }})
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/1.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Sophisticated
                                                                    Swagger Suit
                                                                </a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                                    ...
                                                    <div class="dz-body">
                                                        ...
                                                        <div class="rate">
                                                            ...
                                                            <div class="d-flex">
                                                                <a href="cart" class="btn btn-secondary btn-md btn-icon">
                                                                    <i
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/2.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Cozy Knit
                                                                    Cardigan Sweater</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/3.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Classic Denim
                                                                    Skinny Jeans</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/4.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Athletic Mesh
                                                                    Sports Leggings</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/5.webp" alt="image">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Vintage Denim
                                                                    Overalls Shorts</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/6.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Satin Wrap
                                                                    Party Blouse</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/7.webp" alt="image">
                                                    <div class="product-tag">
                                                        <span class="badge badge-secondary">Sale</span>
                                                    </div>
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Plaid Wool
                                                                    Winter Coat</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                                                </li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/8.webp" alt="image">
                                                </div>
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-details">Water-Resistant
                                                                    Windbreaker
                                                                    Jacket</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a>
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        <div class="row">
                                            @foreach ($products as $product)
                                                @php
                                                    $variant = $product->variants->first(); // default variant
                                                @endphp
                                                ...
                                                <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                                    <div class="shop-card style-1">
                                                        ...
                                                        <!-- TAG -->
                                                        @if ($variant && $variant->mrp_price > $variant->offer_price)
                                                            <div class="product-tag">
                                                                <span class="badge">
                                                                    {{ round((($variant->mrp_price - $variant->offer_price) / $variant->mrp_price) * 100) }}%
                                                                    Off
                                                                </span>
                                                            </div>
                                                        @endif
                            ...
                            <div class="shop-filter mt-xl-2 mt-0">
                                <aside>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap color-filter ps-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel01" value="#000000" aria-label="..." checked>
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel02" value="#9BD1FF" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel03" value="#21B290" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel04" value="#FEC4C4" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel05" value="#FF7354" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel06" value="#51EDC8" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel07" value="#B77CF3" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel08" value="#FF4A76" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel09" value="#3E68FF" aria-label="...">
                                                <span></span>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radioNoLabel"
                                                    id="radioNoLabel20" value="#7BEF68" aria-label="...">
                                                <span></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget widget_categories">
                                        <h6 class="widget-title">Category</h6>
                                        <ul>
                                            <li class="cat-item cat-item-26"><a href="blog-category.html">Dresses</a> (10)
                                            </li>
                                            <li class="cat-item cat-item-36"><a href="blog-category.html">Top &amp;
                                                    Blouses</a> (5)</li>
                                            <li class="cat-item cat-item-43"><a href="blog-category.html">Boots</a> (17)
                                            </li>
                                            <li class="cat-item cat-item-27"><a href="blog-category.html">Jewelry</a> (13)
                                            </li>
                                            <li class="cat-item cat-item-40"><a href="blog-category.html">Makeup</a> (06)
                                            </li>
                                            <li class="cat-item cat-item-40"><a href="blog-category.html">Fragrances</a>
                                                (17)</li>
                                            <li class="cat-item cat-item-40"><a href="blog-category.html">Shaving &amp;
                                                    Grooming</a> (13)</li>
                                            <li class="cat-item cat-item-43"><a href="blog-category.html">Jacket</a> (06)
                                            </li>
                                    ...
                                    <a href="javascript:void(0);"
                                        class="btn btn-sm font-14 btn-secondary btn-sharp">RESET</a>
                                </aside>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Cozy Knit
                                                                    Cardigan Sweater</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Classic Denim
                                                                    Skinny Jeans</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Athletic Mesh
                                                                    Sports Leggings</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Vintage Denim
                                                                    Overalls Shorts</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Satin Wrap Party
                                                                    Blouse</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xxxl-6">
                                            <div class="dz-shop-card style-2">
                                                ...
                                                <div class="dz-content">
                                                    <div class="dz-header">
                                                        <div>
                                                            <h4 class="title mb-0"><a href="shop-list.html">Plaid Wool
                                                                    Winter Coat</a></h4>
                                                            <ul class="dz-tags">
                                                                <li><a href="shop-with-category.html">Accessories,</a></li>
                                                                <li><a href="shop-with-category.html">Sunglasses</a></li>
                                    ...
                                    <div class="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Cozy Knit Cardigan
                                                            Sweater</a></h5>
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Sophisticated Swagger
                                                            Suit</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Classic Denim Skinny
                                                            Jeans</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Athletic Mesh Sports
                                                            Leggings</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Vintage Denim Overalls
                                                            Shorts</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Satin Wrap Party Blouse</a>
                                                    </h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Plaid Wool Winter Coat</a>
                                                    </h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Water-Resistant Windbreaker
                                                            Jacket</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-4 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/9.webp" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Comfy Lounge Jogger Pants</a>
                                                    </h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                ...
                                <div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel"
                                    ...
                                    <div class="row gx-xl-4 g-3">
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/10.webp" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Stylish Fedora Hat
                                                            Collection</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/11.webp" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Suede Ankle Booties
                                                            Collection</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                        ...
                                        <div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
                                            <div class="shop-card style-1">
                                                <div class="dz-media">
                                                    <img src="assets/images/shop/product/12.webp" alt="image">
                                                    <div class="shop-meta">
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-secondary btn-md btn-rounded"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                ...
                                                <div class="dz-content">
                                                    <h5 class="title"><a href="shop-list.html">Hiking Outdoor Gear
                                                            Collection</a></h5>
                                                    <h5 class="price">$80</h5>
                                                </div>
                                                <div class="product-tag">
                                    ...
                                    <div class="swiper-btn-center-lr">
                                            ...
                                            <div class="swiper-wrapper" id="lightgallery">
                                                <div class="swiper-slide">
                                                    <div class="dz-media DZoomImage">
                                                        <a class="mfp-link lg-item" href="assets/images/products/lady-1.webp"
                                                            data-src="assets/images/products/lady-1.webp">
                                                            <i class="feather icon-maximize dz-maximize top-right"></i>
                                                        </a>
                                                        <img src="assets/images/products/lady-1.webp" alt="image">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="dz-media DZoomImage">
                                                        <a class="mfp-link lg-item" href="assets/images/products/lady-2.webp"
                                                            data-src="assets/images/products/lady-2.webp">
                                                            <i class="feather icon-maximize dz-maximize top-right"></i>
                                                        </a>
                                                        <img src="assets/images/products/lady-2.webp" alt="image">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="dz-media DZoomImage">
                                                        <a class="mfp-link lg-item" href="assets/images/products/lady-3.webp"
                                                            data-src="assets/images/products/lady-3.webp">
                                                            <i class="feather icon-maximize dz-maximize top-right"></i>
                                                        </a>
                                                        <img src="assets/images/products/lady-3.webp" alt="image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper quick-modal-swiper thumb-swiper-lg thumb-sm swiper-vertical">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img src="assets/images/products/thumb-img/lady-1.webp" alt="image">
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="assets/images/products/thumb-img/lady-2.webp" alt="image">
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="assets/images/products/thumb-img/lady-3.webp" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dz-content">
                                        <div class="dz-content-footer">
                                            <div class="dz-content-start">
                                                ...
                                                <h4 class="title mb-1"><a href="shop-list.html">Cozy Knit Cardigan
                                                        Sweater</a></h4>
                                                <div class="review-num">
                                        ...
                                        <div class=" cart-btn">
                                            <a href="shop-cart.html" class="btn btn-secondary text-uppercase">Add To
                                                Cart</a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (tooltipSlider) {
                // Poll until noUiSlider is fully initialized by custom.js
