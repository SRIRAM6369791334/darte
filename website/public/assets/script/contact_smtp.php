<?php
/*
Pixio Shop & eCommerce HTML Template | Darte
...
$dzEmailTo 		= "product@Darte.com";   /* Receiver Email Address */
...
function smtp_mail($dzEmailTo, $dzEmailFrom, $dzEmail, $dzMailSubject, $dzMailMessage)
{
    ...
    $mail->Host       = 'Darte.com';                //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'product@Darte.com';                   //SMTP username
